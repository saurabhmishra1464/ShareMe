      ...
      >
        ...
        {postHovered && (
          ...
          >
            ...
            <div className='flex justify-between items-center gap-2 w-fill'>
              {destination && (
                <a
                  href={destination}
                  target='_blank'
                ...
                >
                  ...
                  {destination.length > 20 ? destination.slice(8, 20) : destination.slice()}
                </a>
              )}
              ...
              {postedBy?.id === user.sub && (
                <button
                type='button'
                className='bg-red-500 opacity-70 hover:opacity-100  bg-white text-dark font-bold text-base rounded-3xl hover:shadow-md outlined-none'
                onClick={(e) => {
                  e.stopPropagation();
                  deletePin(_id);
                }}
